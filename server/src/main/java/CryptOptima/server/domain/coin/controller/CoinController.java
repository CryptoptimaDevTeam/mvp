...
public class CoinController {
    ...
    public ResponseEntity getCoins(@RequestParam(value = "page", defaultValue = "1") @Min(1) int page,
    ...
    public ResponseEntity createCoin(@RequestBody @Valid CoinDto.Create coinDto) {
