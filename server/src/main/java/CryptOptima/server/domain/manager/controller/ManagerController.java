...
public class ManagerController {
    ...
    @PostMapping("/login")
    public ResponseEntity loginManager(@RequestBody @Valid LoginDto loginDto) {
    ...
    public ResponseEntity updateManager(@PathVariable("manager-id") @Min(1) Long managerId,
                                        @RequestBody @Valid ManagerDto.Update managerDto) {
    ...
    public ResponseEntity deleteManager(@PathVariable("manager-id") @Min(1) Long managerId) {
